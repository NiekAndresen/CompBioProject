...
# Crossvalidation for a classifier.
# Finds the optimal set of parameters out of a set of candidate parameters for a
# classifier with respect to the given loss function.
# parameters:
# X: input data [N x d]
# y: labels [N] out of {0,1}^N
# method: classifier class that offers fit() and predict() functions
# parameters: dictionary where for each parameter of the classifier a list of values
#             to be tested in crossvalidation is included
# nfolds: number of folds
# nrepetitions: number of repetitions
# loss_function: function that is supposed to be optimized
